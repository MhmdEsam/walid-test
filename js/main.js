...
$(document).ready(function() {
    ...
    /*$('.fixed-menu .nav-item a').click(function (e) {
            e.preventDefault()
            $('html, body').animate({
    ...
    // $(".schedule .carousel-control-prev").click(function(){
    //     $(".schedule .carousel").carousel("prev");
    // });
    // $(".schedule .carousel-control-next").click(function(){
    //     $(".schedule .carousel").carousel("next");
    // });


    $('.schedule .slick-next').html('<i class="fas fa-arrow-left"></i>')
    $('.schedule .slick-prev').html('<i class="fas fa-arrow-right"></i>')
    ...
    $(window).scroll(function() {
        ...
        scrollLink.each(function() {
            ...
            if (sectionOffset <= (scrollbarlocation + 300)) {
                ...
                $(this).parent().siblings().removeClass('active-show')

                /*$(this).children('svg').css({'fill': 'blue', 'backgroundColor': 'black'})
                $(this).parent().siblings().children('a').children('svg').css({'fill': 'white', 'backgroundColor': '#da2128'})*/

            }

            /*if (sectionOffset >= (scrollbarlocation + 300)){
                $(this).children('svg').css({'fill': 'white', 'backgroundColor': '#da2128'})
            }*/
    ...
    var stickyToggle = function(sticky, stickyWrapper, scrollElement) {
        ...
        if (scrollElement.scrollTop() >= stickyTop - 80) {
    ...
    // $(`[data-toggle="blog-sticky-onscroll"]`).each(function () {
    // 	var sticky = $(this);
    // 	var stickyWrapper = $('<div>').addClass('sticky-wrapper')
    //
    // 	sticky.before(stickyWrapper)
    ...
    jQuery(window).scroll(function() {
        ...
        if (scrollBottom < 180) {
            jQuery('.ticketinghub').css('transition', 'all 1s ease-in-out');
            jQuery('.ticketinghub').css('bottom', Math.abs(scrollBottom - 420));
            jQuery('.ticketinghub').css('top', '-300px');
            // jQuery('.ticketinghub').animate({
            //     bottom: Math.abs(scrollBottom - 420),
            //     top: '-327px'
            // }, 1000)
            // jQuery('.ticketinghub').animate({
            //     top: '-327px'
            ...
            jQuery('.ticketinghub').css('transition', 'all 1s ease-in-out');
            jQuery('.ticketinghub').css('bottom', 'auto');
            jQuery('.ticketinghub').css('top', '0');
            // jQuery('.ticketinghub').animate({
            //     bottom: 'auto',
            //     top: '-81px'
            // }, 1000)
...
var WoiqoPlayer = function(t) {
    ...
    this.s = {
        play: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40"><defs><style>.cls-1{fill:#E6AF2E;}</style></defs><g><g><g><path class="cls-1" d="M35.94,17.8c2,1.2,2,3.1,0,4.3L6.26,39.49c-2,1.2-3.7.2-3.7-2.1V2.61c0-2.3,1.6-3.3,3.7-2.1Z"/></g></g></g></svg>',
    ...
    this.container = t,
        ...
        this.range = document.createElement('input'), this.range.className = 'player__slider', setAttributes(this.range, {
            "type": "range",
            "value": 1,
            'max': 1,
            'min': 0,
...
var myVid = document.getElementsByClassName('.player__video')
...
//Start blog ticketinghub
$(window).scroll(function() {
    // if ($('.blog-ticketinghub').scrollTop() >= 30) {
    // 	$('.blog-ticketinghub').addClass('fixed-top')
    // }
    if ($(window).scrollTop() > 310) {
        $('.blog-ticketinghub').addClass('fixed-side')
    } else {
        $('.blog-ticketinghub').removeClass('fixed-side')
    }
})
...
jQuery(window).scroll(function() {
    ...
    if (scrollBottom < 180) {
        jQuery('.blog-ticketinghub').css('transition', 'all 1s ease-in-out');
        jQuery('.blog-ticketinghub').css('bottom', Math.abs(scrollBottom - 420));
        jQuery('.blog-ticketinghub').css('top', '-300px');
        // $('.blog-ticketinghub').removeClass('fixed-side')
        // jQuery('.ticketinghub').animate({
        //     bottom: Math.abs(scrollBottom - 420),
        //     top: '-327px'
        ...
        jQuery('.blog-ticketinghub').css('transition', 'all 1s ease-in-out');
        jQuery('.blog-ticketinghub').css('bottom', 'auto');
        jQuery('.blog-ticketinghub').css('top', '0');
        // $('.blog-ticketinghub').addClass('fixed-side')
        // jQuery('.ticketinghub').animate({
        //     bottom: 'auto',
        //     top: '-81px'
